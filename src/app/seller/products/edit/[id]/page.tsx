...
// Product categories with icons - import from add page in a real implementation
const categories = [
  { id: 1, name: 'Textbooks & Reference' },
  { id: 2, name: 'Stationery' },
  { id: 3, name: 'Past Year Papers' },
  { id: 4, name: 'Electronics' },
  { id: 5, name: 'USB & Storage' },
  { id: 6, name: 'Clothing' },
  { id: 7, name: 'Shoes & Sneakers' },
  { id: 8, name: 'Accessories' },
  { id: 9, name: 'Self-Care & Grooming' },
  { id: 10, name: 'Snacks & Instant Food' },
  { id: 11, name: 'Homemade Food' },
  { id: 12, name: 'Beverages' },
  { id: 13, name: 'Furniture' },
  { id: 14, name: 'Bedding & Pillows' },
  { id: 15, name: 'Room Decorations' },
  { id: 16, name: 'Tutoring Services' },
  { id: 17, name: 'Resume/Templates' },
  { id: 18, name: 'Digital Art' },
  { id: 19, name: 'Board Games' },
  { id: 20, name: 'Tech Gadgets' },
];
...
export default function EditProductPage() {
  ...
  const { fetchProduct, updateProduct, isLoading, error: apiError } = useProducts();
  ...
  }, [productId, fetchProduct]); // Include fetchProduct in dependencies
    ...
    return (
      <div className="min-h-screen bg-[url('/images/backuitm.png')] bg-cover bg-center flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-bold text-black">Loading product data...</p>
        </div>
      </div>
    );
  }

  if (productNotFound || fetchError) {
    return (
      <div className="min-h-screen bg-[url('/images/backuitm.png')] bg-cover bg-center flex items-center justify-center p-4">
        <Card className={`${cartoonStyle.card} bg-white max-w-md w-full mx-auto`}>
          <CardHeader>
            <div className="flex items-center justify-center mb-2">
              <AlertCircle className="h-12 w-12 text-red-500" />
            </div>
            <CardTitle className="text-center text-black font-bold">Product Not Found</CardTitle>
          ...
          <CardContent className="text-center">
            <p className="mb-6 text-gray-700 font-medium">
              Please check the product ID and try again or go back to the product list.
            </p>
            <Button 
    ...
    <div className="min-h-screen bg-[url('/images/backuitm.png')] bg-cover bg-center p-6">
      ...
      <div className="max-w-5xl mx-auto mb-8">
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-yellow-500 text-white px-3 py-1 border-2 border-black font-bold text-lg">Edit Product</Badge>
        </div>
        
        <div className="mt-6">
          <h1 className={`${cartoonStyle.heading} text-black`}>Edit Product</h1>
          <p className="text-gray-700 mt-1 font-medium">Update your product information</p>
        </div>
      </div>
